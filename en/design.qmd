...
![](../assets/images/design/stage_detail-axo.png){fig-alt="Detailed axonometric of a student-play stage wall, showing the interior-space configuration"}

::: {.project-meta}
- **Year** · 2016–2017
- **Type** · Stage Design · Student Theatre
- **Production** · *Last Show*, Winter Production of the SNU Theatre Club
- **Role** · Art Director · planning, design, fabrication, and installation
- **Duration** · ~3 months
:::

I designed the stage for *Last Show*, the winter production of the Seoul National University Theatre Club (총연극회). I took on the whole process — from reading the script and planning the spatial composition, to drafting the drawings, to the actual fabrication and installation. The scale was very different from a city corridor or a district master plan — a single small stage in which several characters pass through one interior — but in the sense of **designing space to follow the flow of a story**, it was actually closer to the archetype of architecture than those larger projects were.

The design brought a single ordinary room onto the stage, while organizing its elements so that the actors could move and the scenes could change. Entryway, living room, bedroom, and bathroom had to coexist within a single scene without their spatial senses colliding — so the key move was to separate them through boundaries of material and lighting. It was a rare chance to design space at a scale outside architecture and urbanism, and the perspective it left me with — **that the movement of the viewer is what completes the space** — became one axis of how I now think about design.
